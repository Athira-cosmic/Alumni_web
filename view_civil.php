...
// Build query
$sql = "SELECT * FROM registration WHERE department IN ('Civil') AND status='approved'";
if ($filter_year) {
				...
				<div class="col-xxl-7 col-xl-7 col-lg-7 col-sm-1 col-1 order-2 order-lg-1">
					...
					<nav class="main-nav">
						...
						<ul>
                            ...
                            <li>
	                            <a href="hod_civil.php">Dashboard</a>
                            </li>
                            <li>
...
<form id="filterForm" method="GET" class="filter-form">
    ...
    <?php if ($filter_year && $filter_course): ?>
        ...
        <select name="department" onchange="submitOnChange()">
            <option value="">-- Select --</option>
            <option value="CSE" <?= $filter_department == 'CSE' ? 'selected' : '' ?>>Civil</option>
        </select>
    <?php endif; ?>

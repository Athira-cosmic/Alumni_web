...
// Build query
$sql = "SELECT * FROM registration WHERE department IN ('ECE', 'AE&I', 'ERE') AND status='approved'";
if ($filter_year) {
				...
				<div class="col-xxl-7 col-xl-7 col-lg-7 col-sm-1 col-1 order-2 order-lg-1">
					...
					<nav class="main-nav">
						...
						<ul>
                            ...
                            <li>
	                            <a href="hod_ece.php">Dashboard</a>
                            </li>
                            <li>
	                            <a href="view_ece.php">View Alumni</a>
                            </li>
                            <li>
...
<form id="filterForm" method="GET" class="filter-form">
    ...
    <?php if ($filter_year && $filter_course): ?>
        ...
        <select name="department" onchange="submitOnChange()">
            <option value="">-- Select --</option>
            <option value="CSE" <?= $filter_department == 'CSE' ? 'selected' : '' ?>>ECE</option>
            <option value="IT" <?= $filter_department == 'IT' ? 'selected' : '' ?>>AE&I</option>
            <option value="ERE" <?= $filter_department == 'ERE' ? 'selected' : '' ?>>ERE</option>
        </select>
    <?php endif; ?>

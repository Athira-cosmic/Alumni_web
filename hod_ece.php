            ...
            <div class="card-body">
                ...
                <div id="memberRequests" class="row">
                    ...
                    foreach ($requests as $request) {
                        ...
                        echo "<a href='hod_ece.php?approve_alumni=" . $request['reg_no'] . "' class='btn btn-success btn-xs'>ACCEPT</a> ";
                        echo "<a href='hod_ece.php?reject_alumni=" . $request['reg_no'] . "' class='btn btn-danger btn-xs'>REJECT</a>";
                        echo "</div></div></div>";
                    }
                    ?>
                </div>
